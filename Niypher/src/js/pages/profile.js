...
import { renderMenuItem } from '../modules/components.js';
import { renderCardSkeleton } from '../modules/components.js';
import { Store, AuthStore, authFlowState } from '../modules/store.js';
        ...
        <div class="auth-page-container">
            <div class="glass-card responsive-card flex flex-col space-y-4 mx-auto">
                <div class="flex items-center justify-center gap-2">
                    ...
                    <div class="skeleton-text skel-base" style="width:80px"></div>
                </div>
