...
export function getHeroExitContext() { return _heroExitContext; }
export function clearHeroExitContext() { _heroExitContext = null; }
export function isHeroExitInFlight() { return _heroExitInFlight; }

export function performHeroExit(routerInstance) {
    if (_heroExitInFlight || _heroInFlight || !_heroExitContext) return;
    _heroExitInFlight = true;

    var targetImg = document.querySelector('[data-hero-role="target"]');
    if (!targetImg) {
        _heroExitInFlight = false;
        routerInstance.push(_heroExitContext.sourcePage);
        _heroExitContext = null;
        return;
    }
    ...
    var toRect = _heroExitContext.sourceRect;
    var toBR = _heroExitContext.sourceBorderRadius;

    var titleClone = null;
    var fromTitleStyle = null;
    var sourceTitleStyle = _heroExitContext.titleStyle;
    ...
    function startAnimation() {
        ...
        function cleanup() {
            ...
            var exitGameId = _heroExitContext ? _heroExitContext.gameId : null;
            _heroExitInFlight = false;
            _heroExitContext = null;
