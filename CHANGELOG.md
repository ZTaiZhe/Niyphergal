...
- **构建产物**: 5.1M
- **变更**: debug: better error reporting for reset-bootstrap
...
- **构建产物**: 5.1M
- **变更**: debug: add temporary /api/debug endpoint for env diagnosis
...
- **构建产物**: 5.1M
- **变更**: chore: redeploy with updated bootstrap invite
...
- **构建产物**: 5.1M
- **变更**: ci: retry study schedule cloud deploy


## Alpha 0.0.1 (build_260714_4)
- **时间**: 2026-07-14 23:03 CST
- **Commit**: 0abe2c5 - ci: trigger study schedule cloud deploy
- **构建产物**: 5.1M
- **变更**: ci: trigger study schedule cloud deploy
...
- **构建产物**: 5.1M
- **变更**: chore: remove emoji from CI release and CHANGELOG, add no-emoji rule


## Alpha 0.0.1 (build_260609_1)
- **时间**: 2026-06-10 01:20 CST
- **Commit**: 434a64a - chore: reset version to 0.0.1 for first release
- **构建产物**: 5.1M
- **变更**: 首版发布
